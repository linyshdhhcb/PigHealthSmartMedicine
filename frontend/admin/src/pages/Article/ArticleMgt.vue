<template>
  <el-card class="p-0">
    ...
    <el-row :gutter="10" v-if="showSearchRow">
          <el-col :span="6">
        ...
        <div class="table-container">
            ...
            >
              ...
              <el-table-column prop="content" label="文章内容" align="center" min-width="300">
                <template #default="scope">
                  ...
                  >
                    <span class="ellipsis">{{ truncateText(stripHtml(scope.row.content), 30) }}</span>
                  </el-tooltip>
                </template>
              </el-table-column>
...
import { articlesAdd, articlesPage, articlesDelete, articleTypesPage } from '@/api/articles.js';
