      ...
      <div class="w-full">
        ...
        <el-row class="w-full flex-1 mt-3 overflow-y-auto">
          <div class="table-container">
            ...
            >
              <el-table-column prop="kindName" label="疾病种类" align="center" min-width="150" />
              <el-table-column prop="illnessName" label="疾病名称" align="center" min-width="150" />
              <el-table-column prop="includeReason" label="诱发因素" align="center" min-width="200">
              ...
              <el-table-column prop="illnessSymptom" label="疾病症状" align="center" min-width="200">
                <template #default="scope">
              ...
              <el-table-column prop="specialSymptom" label="特殊症状" align="center" min-width="200">
                <template #default="scope">
