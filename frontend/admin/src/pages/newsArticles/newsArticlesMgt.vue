    ...
    <el-row class="w-full h-full flex flex-col overflow-x-auto overflow-y-hidden">
      ...
      <div class="w-full" >
          ...
          <el-col :span="6">
            <el-form :model="searchForm" inline label-position="left" >
              <el-form-item label="新闻来源">
                <el-input v-model="searchForm.source" placeholder="请输入新闻来源" />
              </el-form-item>
            </el-form>
          </el-col>
        </el-row>
        ...
        <el-row class="w-full flex-1 mt-3 overflow-y-auto">
          ...
          >
            <el-table-column prop="title" label="新闻标题" align="center" min-width="150" />
            <el-table-column prop="author" label="作者" align="center" min-width="50" />
            <el-table-column prop="source" label="新闻来源" align="center" min-width="150" />
            <el-table-column prop="summary" label="新闻摘要" align="center" min-width="150">
            ...
            <el-table-column prop="publishTime" label="发布时间" align="center" min-width="100" />
...
import { newsArticlesAdd, newsArticlesPage, newsArticlesDelete, newsArticlesUpdate } from '@/api/newsArticles.js';
...
const getPageList = (isReset = false) => {
  ...
  newsArticlesPage(searchForm)
    .then(res => {
      ...
      if (res.code === 200) {
        datatable.records = res.data.data; // 将新闻资讯列表赋值给 datatable.records
