...
```bash
curl http://localhost:8082/api/ragent/knowledge-base
...
| 前端请求                   | 代理后                                          | 后端实际路径                                    |
| -------------------------- | ----------------------------------------------- | ----------------------------------------------- |
| /api/ragent/knowledge-base | http://localhost:8082/api/ragent/knowledge-base | /knowledge-base (context-path已包含/api/ragent) |
