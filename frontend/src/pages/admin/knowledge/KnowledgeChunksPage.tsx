      ...
      <Card className="border-emerald-100 shadow-sm overflow-hidden rounded-2xl">
        <CardHeader className="bg-gradient-to-r from-emerald-50 to-teal-50 border-b border-emerald-100">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <CardTitle className="text-emerald-800">Chunk 列表</CardTitle>
            ...
            <div className="flex flex-1 flex-wrap items-center justify-end gap-3">
              ...
              >
                <SelectTrigger className="w-[160px] h-9 border-emerald-200 focus:ring-emerald-400/20 rounded-xl">
              ...
              <Button
                ...
                className="h-9 px-4 border-emerald-200 text-emerald-700 hover:bg-emerald-50 rounded-xl"
              >
                <RefreshCw className="mr-2 h-4 w-4" />
                刷新
              </Button>
              <Button variant="outline" onClick={() => handleBatchToggle(true)} disabled={selectedList.length === 0} className="h-9 px-4 border-emerald-200 text-emerald-700 hover:bg-emerald-50 rounded-xl">
                <ShieldCheck className="mr-2 h-4 w-4" />
                批量启用
              </Button>
              <Button variant="outline" onClick={() => handleBatchToggle(false)} disabled={selectedList.length === 0} className="h-9 px-4 border-emerald-200 text-emerald-700 hover:bg-emerald-50 rounded-xl">
